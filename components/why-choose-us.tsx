...
export default function WhyChooseUs() {
  const features = [
    ...
    },
    {
      ...
      description: 'Board-certified professionals with extensive expertise',
    },
    {
      title: 'Pain-Free Procedures',
      description: 'Advanced anesthesia and comfort-focused approach',
    },
    {
    ...
    },
    {
      ...
      description: 'Modern, welcoming clinic designed for your comfort',
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mt-6 max-w-2xl mx-auto leading-relaxed">
            We are committed to providing the highest standard of dental care with a personal touch.
          </p>
        </motion.div>
